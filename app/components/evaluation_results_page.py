    ...
    with tab2:
        ...
        with col_cm2:
            cm_analysis_html = (
                ...
                '• <strong>Main Confusion Locus:</strong> The predominant source of classification error is the boundary between <em>Non-Demented</em> and <em>Very Mild Demented</em>, reflecting subtle classification boundaries in early stages.<br>'
                '• <strong>Extreme Separation:</strong> No model in the benchmark ever confused <em>Non-Demented</em> (healthy controls) with <em>Moderate Demented</em> (advanced stage).<br>'
    ...
    with tab4:
        ...
        if per_class_dict:
            ...
            per_class_note = (
                ...
                '• <strong>Very Mild Demented (n=336):</strong> The earliest stage of cognitive decline; primary boundary for inter-model confusion.<br>'
                '• <strong>Mild Demented (n=135):</strong> Intermediate cognitive decline stage exhibiting robust recognition across architectures.<br>'
                '• <strong>Moderate Demented (n=9):</strong> Advanced impairment stage. High sensitivity achieved with class-weighted Cross-Entropy loss; however, the small sample size warrants cautious statistical interpretation.'
                '</div>'
                '</div>'
            )
