...
Captures the Model Prediction card, 3-Model Agreement Engine, Grad-CAM 3-panel attribution,
and 'How to Read This Explanation' user guide.
"""
...
def capture_mri_results():
    ...
    try:
        ...
        # Scroll section[data-testid="stMain"] down to the Grad-CAM & Prediction section
        ...
        out_path = SCREENSHOT_DIR / "page_mri_analysis_prediction_gradcam.png"
        driver.save_screenshot(str(out_path))
        print(f"Captured MRI Analysis results screenshot: {out_path}")
