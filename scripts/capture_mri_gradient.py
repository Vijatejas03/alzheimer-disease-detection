"""
Capture Attribution Color Legend gradient bar and note on MRI Analysis page.
"""
...
def capture_mri_gradient():
    ...
    try:
        ...
        # Scroll section[data-testid="stMain"] down to the gradient bar
        ...
        out_path = SCREENSHOT_DIR / "page_mri_analysis_legend_gradient.png"
        driver.save_screenshot(str(out_path))
        print(f"Captured MRI Analysis legend gradient screenshot: {out_path}")
        
    finally:
        driver.quit()

if __name__ == "__main__":
    capture_mri_gradient()
