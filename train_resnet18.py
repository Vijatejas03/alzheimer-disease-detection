"""
Standalone Training Runner for ResNet-18 on NVIDIA GeForce RTX 3050 (4 GB VRAM).
...
def run_resnet_training():
    logger.info("=" * 75)
    logger.info("  STARTING RESNET-18 REAL TRAINING RUN")
    ...
    summary_path = os.path.join(METRICS_DIR, "resnet18_training_summary.json")
    full_summary = {
    ...
    print("\n" + "=" * 70)
    print("  RESNET-18 REAL TRAINING RUN SUMMARY")
    print("=" * 70)
